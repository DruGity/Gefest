...
function getTemplatePath($template, $type = 'articles'){
...
function generateMeta($meta){
    ...
    if(isset($meta['title_'.$lang]) && $meta['title_'.$lang] != '') $data['title'] = $meta['title_'.$lang];
    elseif(isset($meta['title']) && $meta['title'] != '') $data['title'] = $meta['title'];
    elseif(isset($meta['name'])) $data['title'] = $meta['name'] . $gSeparator . $gTitle;

    if(isset($meta['keywords_'.$lang]) && $meta['keywords_'.$lang] != '') $data['keywords'] = $meta['keywords_'.$lang];
    elseif(isset($meta['keywords']) && $meta['keywords'] != '') $data['keywords'] = $meta['keywords'];
    elseif(isset($meta['keywords'])) $data['keywords'] = $meta['name'] . ', ' . $gKeywords;

    if(isset($meta['description_'.$lang]) && $meta['description_'.$lang] != '') $data['description'] = $meta['description_'.$lang];
    elseif(isset($meta['description']) && $meta['description'] != '') $data['description'] = $meta['description'];
    elseif(isset($meta['description'])) $data['description'] = $meta['name'] . $gSeparator . $gDescription;
...
function myview_exists($view){
    $path = X_PATH . '/application/views/'.TEMPLATE . '/' . $view;
    if(! file_exists($path)){
               return false;
    } else return true;
}
