...
function beforeOutput()
{
    ...
    if ($GLOBALS['beforeOutput'] != true) {
        ...
        $GLOBALS['multilanguage'] = getOption('multilanguage');
        set_userdata('multilanguage', $GLOBALS['multilanguage']);
        ...
        //$GLOBALS['site_name'] = userdata('site_name');
        //if(!$GLOBALS['site_name']) {
        $GLOBALS['cache'] = getOption('cache');
        set_userdata('cache', $GLOBALS['cache']);
        //}
