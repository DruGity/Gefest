...
{
    echo file_get_contents("http://".$_SERVER['SERVER_NAME']."/includes/revslider/slider.php?name=".$name);
    ?>
...
function showTopMenu1($config = false)
{
    $topMenu = new MenuTree1('top', $config);
    echo $topMenu->createTree(0, 0, false, '', false);
}

function showTopMenu2($config = false)
{
    $topMenu = new MenuTree2('top', $config);
    echo $topMenu->createTree(0, 0, false, '', false);
}
