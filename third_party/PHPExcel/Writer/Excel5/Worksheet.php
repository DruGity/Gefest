...
//			if ($row + 1 > 65536 or $column + 1 > 256) {
	 ...
	 * The textual representation of the formula is passed to the parsers in
	 * Parsers.php which returns a packed binary string.
	 *
	 * Returns  0 : normal termination
	...
	private function _writeFormula($row, $col, $formula, $xfIndex, $calculatedValue)
	{
		...
		// Parse the formula using the parsers in Parsers.php
		try {
