...
/////////////////
$route['admin/parsers']          = "admin/parsers/index";
/////////////////
...
$route['admin/parsers']              = "admin/parsers";
$route['admin/parsers/add']          = "admin/parsers/add";
$route['admin/parsers/edit/(.*)']    = "admin/parsers/edit/$1";
...
$route['admin/articles/draganddrop']       = "admin/articles/draganddrop";

$route['admin/articles/import/organisations']       = "admin/articles/import_organisations";

// Импорт ajax
$route['admin/articles/importnew']          = "admin/articles/importnew";
$route['admin/ajax/import']                 = "admin/ajax/import";

$route['admin/ajax/sort']                 = "admin/ajax/sort";
...
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
$route['parse/(.*)']               = "parser/parse/$1";
//$route['parsers/recipes']               = "parser/recipes";
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
...
$route['ajax/get_template_block/(.*)']           = "ajax/get_template_block/$1";
...
$route['ajax/send_mail_form1']           = "ajax/send_mail_form1";
$route['ajax/send_rubrika']           = "ajax/send_rubrika";
...
$route['ajax/set/like']           = "ajax/setLike";
$route['ajax/set/dislike']           = "ajax/setDisLike";
$route['ajax/set/mark']           = "ajax/setMark";
$route['ajax/load/more/products']           = "ajax/loadMoreProducts";
$route['ajax/load/more/articles']           = "ajax/loadMoreArticles";
$route['ajax/load/more/comments']           = "ajax/loadMoreComments";


$route['ajax/set/like/image']           = "ajax/setLikeOnImage";
$route['ajax/set/dislike/image']           = "ajax/setDisLikeOnImage";
$route['ajax/load/articles']           = "ajax/loadArticles";
$route['ajax/load/test']     = "user/loadTest";

$route['ajax/add/comment'] = "ajax/addcomment";

//users
$route['users/all']     = "user/getAllUsers";
$route['users/get/(:num)'] =    "user/get/$1";
$route['users/(:num)'] =  "user/getById/$1";
$route['users/amount'] = "user/amount";
...
$route['shop/exportCat']       = 'shop/exportCat'; // test Export
$route['shop/importCat']       = 'shop/importCat'; // test Import
...
$route['comments/delete/(.*)']              = "comments/delete/$1";
$route['comments/edit/(.*)']              = "comments/edit/$1";
$route['comments/answer/(.*)']      = "comments/answer/$1";

$route['search/(.*)']            = "categories/search";
$route['search']            = "categories/search";
$route['archive/(.*)']           = "categories/archive/$1";
