        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {
                        ?>
                        <div class="login_err" style="color: red;"><?=userdata('login_err')?></div>
                        <?php
                        unset_userdata('login_err');
                    }
                    ?>

                    <h3 style="font-size: 18px">Авторизация через логин и пароль:</h3>
                    <form method="post">
                        <input required type="text" name="login" placeholder="Логин"><br/>
                        <input required type="password" name="pass" placeholder="Пароль"><br/>
