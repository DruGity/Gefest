                            ...
                            <div class="row">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <SELECT id="category_templates" name="template" class="form-control">
<!--                                                <option value="">- нет -</option>-->
                                                <?php
                                                if(isset($cat)){
                                                    $this->load->helper('file');
                                                    $files = get_filenames(X_PATH.'/application/views/'.SITE.'/categories/'.$cat['type'].'/');
                                                    if(!$files) $files = get_filenames(X_PATH.'/application/views/'.SITE.'/templates/categories/'.$cat['type'].'/');
                                                    $count = count($files);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <SELECT id="content_templates" name="content_template" class="form-control">
                                                <option value="">- нет -</option>
                                                <?php
                                                if(isset($cat)){
                                                    $this->load->helper('file');
                                                    $files = get_filenames(X_PATH.'/application/views/'.SITE.'/templates/'.$cat['type'].'/');
                                                    if(!$files) $files = get_filenames(X_PATH.'/application/views/'.SITE.'/'.$cat['type'].'/');
                                                    $count = count($files);
                                                    sort($files);
                                                    for ($i = 0; $i < $count; $i++) {
                                                        echo '<option value="' . $files[$i] . '"';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            if (isset($cat['image']) && $cat['image'] != '') {
                                                ...
                                                echo '<input type="text" class="form-control" name="image" value="http://' .  $_SERVER['SERVER_NAME']. $cat['image'] . '" />';
                                                echo '<input type="hidden" name="image_old" value="' . $cat['image'] . '" />';
                                            }
                                            echo '
