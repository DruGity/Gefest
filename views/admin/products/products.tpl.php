                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            if($page > 3 && $page < $count_products){
                                ...
                                ?>
                                 <li><a href="<?='//'.$_SERVER['SERVER_NAME'].$_SERVER['REDIRECT_URL'].'?page='.$count_products?>"><?='..'.$count_products?></a></li>
                             
                                <?php
                                }
                                elseif($page >= $count_products)
                                {
                                   for ($i=$page-3; $i == $count_products; $i++) {
                                    if ($page == $i) {
                                        ?>
                                        <li class="active"><a href="<?='//'.$_SERVER['SERVER_NAME'].$_SERVER['REDIRECT_URL'].'?page='.$i?>"><?=$i?></a></li>
                                        <?php
