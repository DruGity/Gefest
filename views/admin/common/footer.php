    ...
    <div class="clearfix">
        <ul class="list-unstyled pull-left">
            <li><h6 style="margin: 0;"> &copy;
                    2011-<?=date("Y")?> <?= $this->config->item('cms_name') ?> <?= $this->config->item('cms_version') ?></h6></li>
            <li>Разрабока движка: <a href="//fabrika-umh.com">Фабрика Идей</a> | <a href="tel:+380504923251">+380504923251</a></li>
        </ul>
