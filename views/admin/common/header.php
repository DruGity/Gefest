...
<!--	</span>-->
	...
	<div class="yamm navbar-left navbar-collapse collapse in">
		<ul class="nav navbar-nav">
			...
			<li><a href="/admin/tp/"><span>Техподдержка <i class="fa fa-wrench" aria-hidden="true"></i></span></a></li>
			<li><a target="_blank" href="/"><span> Перейти на сайт <i class="fa fa-angle-double-right" aria-hidden="true"></i></span></a></li>
			<li><a target="_blank" href="/admin/articles/import/organisations"><span> Ипорт организаций <i class="fa fa-angle-double-right" aria-hidden="true"></i></span></a></li>
			<li><a target="_blank" href="#"><span> Вайбер рассылка <i class="fa fa-angle-double-right" aria-hidden="true"></i></span></a></li>
<!--			--><?php
