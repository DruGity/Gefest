...
<head>
    ...
    <meta property = "og:image" content = "http://<?=$_SERVER['SERVER_NAME']?><?php if(isset($article) && isset($category)) echo getOgImage($article,'articles'); elseif(isset($category)) echo getOgImage($category,"categories"); else echo getOption('og_backgroud_image'); ?>"/>
